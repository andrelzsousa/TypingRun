...
function App() {
    ...
    return (
        <div className="main">
            ...
            {!isActive && time !== 0 && textLen !== curIndex.current && (
                <p className="subtitle">Start Typing to begin!</p>
            )}
            ...
            <div className="buttons">
                <Button handler={handleFoward}>
                    <ReplayRoundedIcon fontSize="large" />
                </Button>
                {(time === 0 || textLen === curIndex.current) && (
                    <Finish
                        hits={hits}
                        textLen={textLen}
                        time={time}
                        movieTitle={movie.current.title}
                        curIndex={curIndex}
                        best={best}
                        setBest={setBest}
                    />
